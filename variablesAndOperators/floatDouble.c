...
int main() {
  ...
  // Modify this variable value, start low and increase until something odd
  ...
  // If you were curious about what this code is doing, it is looping through
  // and adding to our variables b and y a set amount of 0.1 on each loop
